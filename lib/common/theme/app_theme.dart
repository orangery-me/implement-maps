  ...
  ThemeSheet(this.themeConfig)
      : themeData = ThemeData(
          ...
          textTheme: TextTheme(
            ...
            headlineLarge:
                TextStyle(fontSize: 32.sp, color: themeConfig.textColor),
            headlineMedium:
                TextStyle(fontSize: 28.sp, color: themeConfig.textColor),
            headlineSmall:
                TextStyle(fontSize: 24.sp, color: themeConfig.textColor),
            titleLarge:
...
class DefaultThemeConfig {
  ...
  Color get lightButtonBackgroundColor => Colors.white;
}
