...
class $AssetsIconsMapGen {
  ...
  AssetGenImage get pin => const AssetGenImage('assets/icons/map/pin.png');

  /// File path: assets/icons/map/start.png
  AssetGenImage get start => const AssetGenImage('assets/icons/map/start.png');

  /// List of all assets
  List<AssetGenImage> get values => [pin, start];
}
